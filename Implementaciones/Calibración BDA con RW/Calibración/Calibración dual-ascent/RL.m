...
numRep = 2500; % Número de repeticiones de cada set de episodios
numEpisodes = 50; % Número de episodios de cada repeticion
...
alphaD = 0.05; % Stepsize para la iteración de la variable dual d
