...
title('QL - \Sigmaq(s,a) for each episode')
...
title('QL - \Sigmav(s) for each episode')
...
title('QL - Mean-squared error of q(s,a) for each episode')
...
title('QL - Mean-squared error of v(s) for each episode')
