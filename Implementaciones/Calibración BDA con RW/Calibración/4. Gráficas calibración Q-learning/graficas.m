...
%%
load('4. Gráficas calibración Q-learning\Pruebas alfa\errorPolicy_alpha.mat')
...
title('Policy error. Pruebas \alpha (Q-learning)')

% load('4. Gráficas calibración Q-learning\Pruebas alfa\Gmean_alpha.mat')
...
%%
load('4. Gráficas calibración Q-learning\Pruebas epsilon\errorPolicy_epsilon.mat')
figure, plot([1:size(errorPolicy_mean_todos,2)], errorPolicy_mean_todos, 'LineWidth',2)
legend('\epsilon = 0','\epsilon = 0.01','\epsilon = 0.03','\epsilon = 0.05','\epsilon = 0.07'...
...
title('Policy error. Pruebas \epsilon (Q-learning)')

load('4. Gráficas calibración Q-learning\Pruebas epsilon\Gmean_epsilon.mat')
figure, plot([1:size(Gmean_todos,2)], Gmean_todos, 'LineWidth',2)
legend('\epsilon = 0','\epsilon = 0.01','\epsilon = 0.03','\epsilon = 0.05','\epsilon = 0.07'...
    ,'\epsilon = 0.1','\epsilon = 0.13','\epsilon = 0.15','\epsilon = 0.17','\epsilon = 0.2'...
    ,'\epsilon = 0.25','\epsilon = 0.3','\epsilon = 0.4','\epsilon = 0.5','\epsilon = 0.9')
