...
alphaD = 0.1; % Stepsize para la iteración de la variable dual d % 0.1 valor original
alphaTD = 0.08; % Stepsize para la iteración de la variable primal v
...
hold off, title(['BDA-MF Return per episode (always starting at s=' ,num2str(env.initState), ')'])
