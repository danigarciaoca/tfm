...
numFilTablero = 4;
numColTablero = 12;
rewards = [-1, -15]; % -1 en todas las transiciones, -15 si cae al cliff
...
alphaD = 0.01; % Stepsize para la iteración de la variable dual d % 0.1 valor original
alphaTD = 0.01; % Stepsize para la iteración de la variable primal v
