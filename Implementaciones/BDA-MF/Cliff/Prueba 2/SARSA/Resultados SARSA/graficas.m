...
alfa = [0.10 0.15 0.20 0.25 0.3 0.35 0.4 0.5 0.6 0.7 0.75 0.8 0.85 0.9 0.95 1 2];
epsilon = [0.00001 0.00005 0.0001 0.0005 0.001 0.005 0.01 0.05 0.10 0.15 0.20];
...
legend('\alpha = 0.10','\alpha = 0.15','\alpha = 0.20','\alpha = 0.25','\alpha = 0.30'...
    ,'\alpha = 0.35','\alpha = 0.40','\alpha = 0.50'...
    ,'\alpha = 0.60','\alpha = 0.70','\alpha = 0.75','\alpha = 0.80'...
    ,'\alpha = 0.85','\alpha = 0.90','\alpha = 0.95','\alpha = 1','\alpha = 2')
...
figure, plot([1:size(Gmean_todos,2)], Gmean_todos, 'LineWidth',2)
legend('\epsilon = 0.00001','\epsilon = 0.00005','\epsilon = 0.0001','\epsilon = 0.0005','\epsilon = 0.001','\epsilon = 0.005','\epsilon = 0.01','\epsilon = 0.05','\epsilon = 0.1','\epsilon = 0.15','\epsilon = 0.2')
