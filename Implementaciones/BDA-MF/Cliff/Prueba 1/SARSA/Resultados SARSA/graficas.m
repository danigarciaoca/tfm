...
legend('\alpha = 0.10','\alpha = 0.15','\alpha = 0.20','\alpha = 0.25','\alpha = 0.30'...
       ...
       ,'\alpha = 0.85','\alpha = 0.90','\alpha = 0.95','\alpha = 1')
...
figure, plot([1:size(Gmean_todos,2)], Gmean_todos, 'LineWidth',2)
legend('\epsilon = 0.0001','\epsilon = 0.0005','\epsilon = 0.001','\epsilon = 0.005','\epsilon = 0.01','\epsilon = 0.05','\epsilon = 0.1','\epsilon = 0.15','\epsilon = 0.2')
