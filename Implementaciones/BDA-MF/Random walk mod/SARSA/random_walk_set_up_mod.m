function game = random_walk_set_up_mod(N_states, transitionType, rewardType)
% Random Walk problem
...
if strcmp(rewardType, 'rand')
    ...
    % entre 1 y 3
    R(s_a_reward_index)=randi([1 2], 3,1);
...
game=struct('N_states',N_states,'N_actions',N_actions,'P',P,'R',R,'finalState',...
    ...
    'centralState',centralState,'mu',mu,'duplicar',duplicar)
end