function q_learning_func( numExperiments, numEpisodes, epsilon, alpha, rltv_path)
...
for exp = 1:numExperiments
    ...
    [~, ~, G_eps0] = q_learning_core(game, Qsa, 0, alpha, numEpisodes, maxNumStepsPerEpisode, init_state);
...
save([rltv_path '\nExp=' num2str(numExperiments) ',nEpi=' num2str(numEpisodes) ',alpha=' num2str(alpha) ',eps=' num2str(epsilon) '.mat'])
end
