...
% % % % AGENTE:
numExperiments = 25; % Número de experimentos sobre el que se promedia
...
title(['Policy error. epsilon = ' num2str(epsilon) ',alpha = ' num2str(alpha)])
